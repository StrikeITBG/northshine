...
class Mls_Banner_slider2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( ' Banner Slider 2', 'poket' );
    }
    ...
    protected function register_controls() {
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( ' Banner Title Options', 'poket' ),
			...
			/* banner slider style check  witr_style_banner */
				$this->add_control(
					'witr_style_banner',
					[
						'label' => esc_html__( 'Banner Slider Style', 'poket' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'1' => esc_html__( 'slider style 1', 'poket' ),
							'2' => esc_html__( 'slider style 2', 'poket' ),
							'3' => esc_html__( 'slider style 3', 'poket' ),
							'4' => esc_html__( 'slider style 4', 'poket' ),
							'5' => esc_html__( 'slider style 5', 'poket' ),
				...
				/* main banner witr_banner_title1 */	
					$this->add_control(
						...
						[
							...
							'default' => esc_html__( 'Add Your banner title Here', 'poket' ),
							'placeholder' => esc_attr__( 'Type your banner title here', 'poket' ),						
						]
					);
				/*  witr_banner_title2 */	
					$this->add_control(
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( ' Banner Button Options', 'poket' ),
					'tab' => Controls_Manager::TAB_CONTENT,
				]
			);
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Witr Banner Social Options', 'poket' ),
					'tab' => Controls_Manager::TAB_CONTENT,
					'condition' => [
				...
				/* main banner witr_banner_fb */	
					$this->add_control(
						'witr_banner_fb',
						[
							'label' => esc_html__( 'facebook Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link facebook. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '#',
								'is_external' => true,
				...
				/* main banner witr_banner_tw */	
					$this->add_control(
						'witr_banner_tw',
						[
							'label' => esc_html__( 'twitter Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
				...
				/* main banner witr_banner_gp */	
					$this->add_control(
						'witr_banner_gp',
						[
							'label' => esc_html__( 'google-plus Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link google plus. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
				...
				/* main banner witr_banner_lk */	
					$this->add_control(
						'witr_banner_lk',
						[
							'label' => esc_html__( 'linkedin-in Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link linkedin. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
				...
				/* main banner witr_banner_pi */	
					$this->add_control(
						'witr_banner_pi',
						[
							'label' => esc_html__( 'pinterest-p Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link pinterest. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
				...
				/* main banner witr_banner_in */	
					$this->add_control(
						'witr_banner_in',
						[
							'label' => esc_html__( 'instagram Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link instagram. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
				...
				/* main banner witr_banner_us*/	
					$this->add_control(
						'witr_banner_us',
						[
							'label' => esc_html__( 'users Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link users. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
					...
					$this->add_control(
						'witr_banner_tu',
						[
							'label' => esc_html__( 'tumblr Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link tumblr. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '#',
								'is_external' => true,
					...
					$this->add_control(
						'witr_banner_vi',
						[
							'label' => esc_html__( 'vimeo Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link vimeo. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '#',
								'is_external' => true,
					...
					$this->add_control(
						'witr_banner_yt',
						[
							'label' => esc_html__( 'Youtube Link', 'poket' ),
							'type' => Controls_Manager::URL,
							'placeholder' => esc_attr__( 'https://your_site.com', 'poket' ),
							'description' =>esc_html__('Insert link Youtube. It hidden when field blank.','poket'),
							'show_external' => true,
							'default' => [
								'url' => '',
								'is_external' => true,
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__( 'Witr Banner Image Options', 'poket' ),
					'tab' => Controls_Manager::TAB_CONTENT,
				]
			);
			...
			$this->start_controls_section(
				'witr_sliders_height',
				[
					'label' => esc_html__( 'Witr Slider Height Options', 'poket' ),
					'tab' => Controls_Manager::TAB_CONTENT,
				]
			);			
	   ...
	   /*===========================================================================================
		...
		/*=== end  w_heighlight style ====*/		
				...
				$this->start_controls_tabs( 'button_colors' );
					...
					$this->add_control(
						...
						$this->add_control(
							'witr_hidden_input',
							[
								'label' => esc_html__( 'Input Color Option ', 'poket' ),
						...
						$this->add_control(
							'witr_moz_color',
							[
								'label' => esc_html__( 'Moz Placeholder Color', 'poket' ),
								'type' => Controls_Manager::COLOR,
								'selectors' => [
					...
					$this->add_control(
						...
						$this->add_responsive_control(
							'witr_input_width',
							[
								'label' => esc_html__( 'Input width', 'poket' ),
								'type' => Controls_Manager::SLIDER,
								'size_units' => [ '%', 'px', 'em' ],
								'range' => [
									'%' => [
						...
						$this->add_responsive_control(
							'witr_height_input',
							[
								'label' => esc_html__( 'Input Heigh', 'poket' ),
								'type' => Controls_Manager::SLIDER,
								'size_units' => ['px', 'em' ],
								'range' => [
									'em' => [
					...
					$this->add_control(
						'witr_hiddenaf_view',
						[
							'label' => esc_html__( 'Forground Hover Color ', 'poket' ),
							'type' => Controls_Manager::HEADING,
						]
					);						
			...
			$this->add_control(
				'witr_vbtnt_color',
				[
					'label' => esc_html__( 'Video Btn Text Color', 'poket' ),
					'type' => Controls_Manager::COLOR,
					'global' => [
						'default' => Global_Colors::COLOR_ACCENT,
					],					
			...
			$this->add_responsive_control(
				'witr_vbtnt_margin',
				[
					'label' => esc_html__( 'Video Btn Text Margin', 'poket' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
			...
			$this->add_responsive_control(
				'witr_vbtnt_padding',
				[
					'label' => esc_html__( 'Video Btn Text Padding', 'poket' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em' ],
					'selectors' => [
				...
				/*=== end icon normal style ====*/
					...
					$this->add_control(
						...
						[
							'label' => esc_html__( 'Video Btn Text Hover Color', 'poket' ),
							'type' => Controls_Manager::COLOR,
							'separator'=>'before',
							'selectors' => [
		...
		/*=== end witr_icon style ====*/
			...
			$this->start_controls_section(
				'section_style_icon2',
				[
					'label' => esc_html__( 'Icon2 Color Option', 'poket' ),
					'tab' => Controls_Manager::TAB_STYLE,				
					'condition' => [
						'witr_style_banner' => ['3','4'],
						'witr_social_show' => 'yes',
			...
			$this->start_controls_tabs( 'icon2_colors' );
				...
				$this->add_control(
					'witr_icon2_color',
					[
						'label' => esc_html__( 'Icon2 Color', 'poket' ),
						'type' => Controls_Manager::COLOR,
						'separator'=>'before',
						'default' => '',
						'selectors' => [
				...
				$this->add_responsive_control(
					'witr_icon2_size',
					[
						'label' => esc_html__( 'Icon2 Size', 'poket' ),
						'type' => Controls_Manager::SLIDER,
						'range' => [
							'px' => [
								'min' => 6,
				...
				$this->add_control(
					'witr_hidden_icon3',
					[
						'label' => esc_html__( 'Icon2 background Color', 'poket' ),
						'type' => Controls_Manager::HEADING,
						'default' => 'heading',							
					]
				);					
				...
				$this->add_group_control(
					...
					[
						...
						'label' => esc_html__( 'Icon2 Background', 'poket' ),
						'types' => ['classic','gradient'],
				...
				$this->add_responsive_control(
					'witr_icon2_margin',
					[
						'label' => esc_html__( 'Icon2 Margin', 'poket' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
				...
				$this->add_responsive_control(
					'witr_icon2_padding',
					[
						'label' => esc_html__( 'Icon2 Padding', 'poket' ),
						'type' => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', '%', 'em' ],
						'selectors' => [
				...
				/*=== end icon2 normal style ====*/
					...
					$this->start_controls_tab(
						'icon2_colors_hover',
						[
							'label' => esc_html__( 'Icon2 Hover', 'poket' ),
						]
					);
					/*  primary hover color */
					$this->add_control(
					...
					$this->add_control(
						'witr_hidden_icon2',
						[
							'label' => esc_html__( 'Icon2 Hover background Color', 'poket' ),
							'type' => Controls_Manager::HEADING,
							'default' => 'heading',							
						]
					);					
					...
					$this->add_group_control(
						...
						[
							...
							'label' => esc_html__( 'Icon2 Hover Background', 'poket' ),
							'types' => [ 'classic', 'gradient'],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Images Option', 'poket' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);		 
				...
				<div class="row">
					<div class="col-lg-6 col-md-12">
                        ...
                        <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
							<input type="text" name="s" value="<?php the_search_query(); ?>" placeholder="<?php echo esc_attr_e( 'Categories', 'poket' ) ?>" title="<?php echo esc_attr_e( 'Search for:', 'poket' ) ?>" />
                            <button type="submit" ><?php esc_html_e('Search','poket');?></button>
                        </form>
