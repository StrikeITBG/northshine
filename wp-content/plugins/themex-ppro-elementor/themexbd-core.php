<?php
/*
* Plugin Name: Themex Pro Addon For Poket Restaurant Theme
* Plugin URI: https://webitrangpur.com/
* Description: This plugin is mandatory for poket theme. you can created best website using the plugin.
* Version: 1.0.0
